...
const Sidenav = () => {
  ...
  return (
    <nav className="flex flex-col px-3 py-1 w-40 h-svh text-sm">
      <button
        className="w-full h-22 py-5 border-b-2"
        onClick={() => navigate("/")}
      >
        <Logo />
      </button>
      <div className="w-full h-16 py-5 border-b-2 flex justify-around">
      ...
      <div className="w-fit px-2  rounded-md font-pretendard flex justify-between items-center gap-3 list-none ">
        <li className=" text-red-600 text-4xl cursor-pointer hover:text-slate-200">
          <FaYoutube />
        </li>
        <li className="text-xl cursor-pointer  bg-black rounded-md p-1 text-white hover:bg-slate-200">
          <FaXTwitter />
        </li>
        <li className="text-3xl cursor-pointer rounded-md p-1 text-sky-600 hover:text-slate-200">
          <FaFacebook />
        </li>
      </div>
